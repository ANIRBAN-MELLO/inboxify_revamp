...
<div class="content-wrapper">
    ...
    <?php elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'order') : ?>
        ...
        <?php if (isset($_SESSION['id'])) : ?>
            ...
            <div class="container">
                <div class="medium-padding120">
                    ...
                    <form action="pricing_query.php" class="form" method='POST'>
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <textarea style="border-radius: 50px;" name="order_query" class="input-dark site" cols="60" rows="10" required></textarea>
                                </div>
                            </div>
